        ...
        <template v-if="asset.id">
            <div class="flex flex-col sm:flex-row justify-around items-center">
                ...
                >
                    ...
                    <span class="text-xl"
                        >{{ convertResult }}
                        {{ fromUsd ? `${this.asset.symbol}` : `USD` }}</span
                    >
                </div>
            </div>
            ...
            <h3 class="text-xl my10">Mejores ofertas de cambio</h3>
            <table>
                <tr
                    v-for="m in markets"
